...
const publicEnvSchema = z.object({
  ...
  // "true" ⇒ load the Meta Pixel outside production so you can verify events in
  // Meta's Pixel Helper / Test Events. Mirrors NEXT_PUBLIC_GA_DEBUG. WARNING:
  // browser-pixel events in dev hit the REAL pixel — leave blank in production.
